            ...
            while ($subject = mysqli_fetch_assoc($result_subject)) {
                echo ' <div class= "view_teacher_subjects">
                    <div  class="subject">' . $subject['subject_name'] . '</div> 
                     <a href ="https://localhost/Attendance%20System%20project/Teachers%20dashboard/view_attendance_table.php?sem_id=' . $subject['semester_id'] . '&sub_id=' . $subject['subject_id'] . '" class="attendance_tbl">attendance</a>
                    <a  href="https://localhost/Attendance%20System%20project/Teachers%20dashboard/view_record_subject_wise.php ?sem_id=' . $subject['semester_id'] . '&sub_id=' . $subject['subject_id'] . '" class="view_student_tbl">view record</a>
