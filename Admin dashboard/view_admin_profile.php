        ...
        if (mysqli_num_rows($admin_detail_result) > 0) {
            while ($admin_row = mysqli_fetch_assoc($admin_detail_result)) {
                ...
                <div class="admin_dash_detail">
                    <a  href="https://localhost/Attendance%20System%20project/Admin%20dashboard/Admin_dashboard.php" class="admin_profile_back">back</a>
                    <h2>your details</h2>
                    ...
                    <a onclick="return confirm(\'are you sure for edit\')" href="https://localhost/Attendance%20System%20project/Admin%20dashboard/edit_admin_profile.php?id=' . $admin_row['id'] . '" class="admin_details_update">edit my details</a>
                </div>
                ';
            }
        } else {
