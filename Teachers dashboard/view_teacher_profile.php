        ...
        if (mysqli_num_rows($teacher_detail_result) > 0) {
            while ($teacher_row = mysqli_fetch_assoc($teacher_detail_result)) {
                ...
                <div class="teacher_view_detail">
                    <a  href="https://localhost/Attendance%20System%20project/Teachers%20dashboard/teacher_dashboard.php" class="teacher_profile_back">back</a>
                    <h2>your details</h2>
                ...
                <a onclick="return confirm(\'are you sure for edit\')" href="https://localhost/Attendance%20System%20project/Teachers%20dashboard/edit_teacher_profile.php?id=' . $teacher_row['id'] .'" class="teacher_details_update">edit my details</a>
                    </div>
                ';
            }
        } else {
