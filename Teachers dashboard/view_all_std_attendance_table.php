...
<body>
    <form action="https://localhost/Attendance%20System%20project/database%20and%20tables/attendace_record_insert.php"
        method="post">
        ...
        <a href="https://localhost/Attendance%20System%20project/Teachers%20dashboard/view_record_subject_wise.php ?sem_id=' . $semester_id. '">view attendance record</a>
        </div>';
    echo '</div>';
            } else {
                echo 'Data not found';
