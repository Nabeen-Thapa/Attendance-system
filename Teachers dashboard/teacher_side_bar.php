...
<body>
    <div class="teacher_side_bar">
        ...
        <a href="https://localhost/Attendance%20System%20project/Teachers%20dashboard/view%20students.php"
        ...
        <a href="https://localhost/Attendance%20System%20project/Teachers%20dashboard/view_attendance_all_record.php"
            class="menus" id="Arecord"><img src="../images/present students.png" alt="" class="teach_dashimg">Attendance
            records</a>

            <!-- <a href="https://localhost/Attendance%20System%20project/Teachers%20dashboard/view_teachers_semesters.php" class="menus"
