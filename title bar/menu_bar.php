...
<body>
    <div class="menu_bar">
        ...
        <ul>
            <li><a href="#" class="menus" data-page="Teachers dashboard/teacher_dashboard.php">Dashboard</a></li>
            <li><a href="#" class="menus" data-page="profile.php">Profile</a></li>
            <li><a href="#" class="menus" data-page="settings.php">Settings</a></li>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#page-content').load('Teachers dashboard/teacher_dashboard.php');
