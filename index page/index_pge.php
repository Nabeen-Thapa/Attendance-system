    ...
    <center>
        <form id="idchoosetype">
            ...
            <div id="idloginborder">
                ...
                <a href="https://localhost/Attendance%20System%20project/Admin%20dashboard/Admin_login.php" class="loginopen" id="idlogin-choose">Admin</a>
                <a href="https://localhost/Attendance%20System%20project/Teachers%20dashboard/teacher_login.php" class="loginopen" id="idlogin-choose">Teacher</a>
