            ...
            <div class="selectcourse">
                ...
                <div>
                    ...
                    <select id="idselectsem" name="selectsem" value="<?php echo $student_data['semester']; ?>">
                        ...
                        <option value="First semester" value="<?php echo $student_data['semester']; ?>>first semester</option>
                        <option value="second semester" value="<?php echo $student_data['semester']; ?>>second semester</option>
                        <option value="third semester" value="<?php echo $student_data['semester']; ?>>third semester</option>
                        <option value="fourth semester" value="<?php echo $student_data['semester']; ?>> fourth semester</option>
                        <option value="fifth semester" value="<?php echo $student_data['semester']; ?>>fifth semester</option>
                        <option value="sixth semester" value="<?php echo $student_data['semester']; ?>>sixth semester </option>
                        <option value="seventh semester" value="<?php echo $student_data['semester']; ?>>seventh semester </option>
                        <option value="eignth semester" value="<?php echo $student_data['semester']; ?>> eighth semester</option>
                    </select>
                </div>
